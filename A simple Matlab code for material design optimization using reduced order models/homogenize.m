...
% based on the homogenize.m code written by E. Andreassen, C.S. Andreasen 
% presented in the paper "How to determine composite material properties 
% using numerical homogenization",
% E. Andreassen, C.S. Andreasen,
