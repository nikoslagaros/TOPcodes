function [CH,DCH] = homo3DY(lx,ly,lz,E,dE,nu,Emin,hk,p)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if p.sameSize(size(F(activedofs(4:end),1),1)) == false
    p = p.reinitialize();
end
for i = 1:6
    X(activedofs(4:end),i) = p.solve(K(activedofs(4:end),...
        activedofs(4:end)),F(activedofs(4:end),i));
end
%% HOMOGENIZATION
